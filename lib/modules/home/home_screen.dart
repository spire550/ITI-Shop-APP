...
class Home extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    child: BlocConsumer<HomeLayoutCubit,HomeLayoutStates>(
        builder:(context,state)=> HomeLayoutCubit.get(context).homeModel == null || HomeLayoutCubit.get(context).categoriesModel == null? Center(child: CircularProgressIndicator(color: Colors.teal,)) : HomeView(HomeLayoutCubit.get(context).homeModel,HomeLayoutCubit.get(context).categoriesModel,HomeLayoutCubit.get(context).isFavorite,context),
            ...
            Row(
              children: [
                Padding(
                  ...
                  child: Text("${model.data!.products[index].price.toString()} EGP",style: TextStyle(color: Colors.teal),),
                ),
                ...
                CircleAvatar(
                  ...
                  backgroundColor:fav[model.data!.products[index].id]??false ?Colors.teal:Colors.grey[300],
                  child: IconButton(
